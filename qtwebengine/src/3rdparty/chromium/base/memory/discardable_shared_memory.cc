...
#define MADV_PURGE_ARGUMENT MADV_FREE
  ...
  // so resolve it at run time as Chromium did up to 109.0.5414.120. Where it is
  // missing the MEM_RESET path below is taken, which is what Windows 7 always
  // used and which satisfies the same contract (contents become undefined).
