...
// Windows 7 backport: (Un)RegisterSuspendResumeNotification() were introduced
// in Windows 8, so resolve them at run time as Chromium did up to
// 109.0.5414.120. On Windows 7 registration is not needed in the first place:
// WM_POWERBROADCAST/PBT_APMSUSPEND is delivered to every top-level window
// there, the registration only being required for modern standby machines.
