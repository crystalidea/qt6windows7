This is Qt 6.7.2 backport that runs on Windows 7/8. The repository contains patched source files from the qtbase module. 
...
- You can use our [compile_win.pl](https://github.com/crystalidea/qt-build-tools/tree/master/6.6.2) build script (uses Visual C++ 2019 with OpenSSL 3.0.13 statically linked)
