...
The most recent supported version is **6.9.3** however many older versions are supported as well (see **Older versions** section).
...
**Qt 6.9.3 designer running on Windows 7**:
